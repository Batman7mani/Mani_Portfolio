    ...
    <main>
      ...
      <section className="hero section-pad" id="top">
        <div className="hero-copy">
          ...
          <Reveal className="delay-3"><a className="circle-link" href="/Mani-Chandhan-Resume.pdf" target="_blank" rel="noreferrer" aria-label="Open resume"><ArrowDownRight size={25} /></a><span className="circle-link-caption">Resume / HR</span></Reveal>
        </div>
